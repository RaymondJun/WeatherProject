...
<!--[if !IE]><!--> <html lang="en" style=""> <!--<![endif]-->  
<head>
    <title>알 람</title>
	...
	<!-- digitAlarm -->
	<link rel="stylesheet"  href="${pageContext.request.contextPath }/resources/digitTime/Alarm.css">
...
<script type="text/javascript">
	$(function() {
		...
		var MM = $("#timeM").val();
		var Rtime = HH+MM;
		if(Rtime!=0 || Rtime!=null || Rtime!=" "){
			alert("Rtime : "+Rtime);
		} */
		console.log(`${times },${gu},${dong }`);
		$("#alarm-reset").on('click', function() {
		  	$("#showAlarm").fadeIn();
			$("#showCard").fadeOut();
	  	});
...
<body >    
<div class="wrapper" style="background-color:  #dbe4e6; font-size: 20px;">
    <!--=== Header ===-->    
    <div class="header">
        <div class="container">
            <!-- Logo -->
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="about">Weather에 대하여</a></li>
                                    </ul>                                
                                </li>
                                <!-- End About Pages -->
                            </ul>
	...
	<!--  table start -->
	<div style="text-align: center; background-color:#dbe4e6; " id="showAlarm" >
		<h3>원하시는 시간에 알람을 맞춰보고<br>
			그 시각의 날씨에 맞추어 자신의 스케줄을 조정하는 건 어떨까요?</h3>
		<!-- <input  style="border-radius:20px; width: 200px; height: 50px; font-size: 30px;font-style:bold; text-align: center;"  type="text" id="alarm" />-->
		...
		<div class="button-holder">
				<a id="switch-theme" class="button">테마 바꾸기</a>
				<a class="alarm-button"><img src="${pageContext.request.contextPath }/resources/digitTime/alarm_btn.png"></a>
		</div>
		...
		<div class="overlay">
			<div id="alarm-dialog">
				...
				<div class="button-holder">
					<a id="alarm-set" class="button blue">알람설정</a>
					<a id="alarm-clear" class="button red">취 소</a>
				</div>
				<a class="close"></a>
			</div>
		</div>
		<div class="overlay">
		    <div id="time-is-up">
		        <h2>Time's up!</h2>
		        <div class="button-holder">
		            <a class="button blue" id="weather" >현재날씨</a>
		        </div>
		    </div>
		</div>
	</div>
	<div class="background" hidden="" id="showCard">
		<div class="Wcontainer">	
			...
			<svg id="outer" style="position: fixed;pointer-events: none;"></svg>
				<div class="button-holder">
					<a id="alarm-reset" class="button blue">알람 재설정</a>
				</div>
		</div>
	</div>
    <!--=== Footer Version 1 ===-->
