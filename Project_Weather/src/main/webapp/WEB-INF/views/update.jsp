...
<div class="container">
    <!--Reg Block-->
    <div class="reg-block">
    	<form action="updateOk" onsubmit="return formCheck();" method="post">
        ...
        <div class="input-group margin-bottom-10">
	        <div class="input-group" style="float: left;width:50%; padding: 5px;">
	            ...
	            <input type="text" class="form-control"  name="custno" value="${custVO.custno }" id="custno">
	        </div>
	        <div class="input-group " style="float: right; width:50%;padding: 5px;">
	            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
	            <input type="text" class="form-control" placeholder="Email" id="cemail" name="cemail" value="${custVO.cemail }">
	        </div>
	     </div>
        <div class="input-group margin-bottom-10">
	        <div class="input-group" style="float: left;width:50%; padding: 5px;">
        ...
        <div class="input-group margin-bottom-10">
	        <div class="input-group" style="float: left;width:50%; padding: 5px;">
	            ...
	            <input type="text" class="form-control" placeholder="이 름" id="cname" name="cname" value="${custVO.cname }">
	        </div>
	        <div class="input-group" style="float: left;width:50%; padding: 5px;">
	            <span class="input-group-addon"><i class="fa fa-film"></i></span>
	            <input type="text" class="form-control" placeholder="닉 네 임"   id="cnickname"   name="cnickname" value="${custVO.cnickname }">
        	</div>
	    </div>
        <div class="input-group margin-bottom-10">
	        <div class="input-group" style="float: left;width:56%; padding: 5px;">
	            <span class="input-group-addon"><i class="fa fa-calendar-o"></i></span>
	            <input type="text" class="form-control" placeholder="생년월일" id="cbirth" name="cbirth" value="${custVO.cbirth }" >
	        </div>
	    <div class="checkbox" style="margin-left:20px; float: right;">
	    	<label style=" margin-right: 50px">
	    		<input type="checkbox" name="cgender"  id="cgender1" value="M" > 남성
	    	</label>
	    		<input type="hidden" name="cgender" id="cgender" value="${custVO.cgender }"/>
	    	<label>
	    ...
	    <div class="input-group margin-bottom-10">
	        <div class="input-group" style="float: left;width:50%; padding: 5px;">
	            ...
	            <input type="text" class="form-control" placeholder="전화 번호" id="cphone" name="cphone" value="${custVO.cphone }">
        	</div>
		    <div class="input-group" style="float: left;width:50%; padding: 5px;">
		            <span class="input-group-addon"><i class="fa fa-home"></i></span>
		            <input type="text" class="form-control" placeholder="우편번호 찾기" id="czipcode" readonly="readonly" name="czipcode" value="${custVO.czipcode }">
		    </div>
		</div>
	    <div class="input-group margin-bottom-15" >
	            <span class="input-group-addon"><i class="fa fa-home"></i></span>
	            <input type="text" class="form-control" placeholder="주 소" id="caddress" readonly="readonly" name="caddress" value="${custVO.caddress }">
	    </div>
	    <div class="input-group margin-bottom-10" >
	            <span class="input-group-addon"><i class="fa fa-home"></i></span>
	            <input type="text" class="form-control" placeholder="상세 주소" id="caddress2" name="caddress2" value="${custVO.caddress2 }" >
	    </div>
	    	<input type="hidden" name="enabled" id="enabled" value="1"/>
        <hr>
            <div style="text-align: center;">
                <button type="submit" class="btn-u" id="updateBtn">수정 하기</button>                
