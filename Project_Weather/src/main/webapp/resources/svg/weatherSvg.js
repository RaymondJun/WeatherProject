...
var weather = [
	{ type: 'snow', class: '', intensity: 1, name: '눈'}, 	
	...
	{ type: 'wind', class: '', intensity: 1, name: '쌀쌀'},		 
	{ type: 'rain', class: '', intensity: 1, name: '비'}, 		
	{ type: 'hail', class: '', intensity: 2, name: 'Hail Storm'}, 		
	{ type: 'thunder', class: '', intensity: 1, name: '폭풍'},	
	{ type: 'severe', class: '', intensity: 2, name: 'T Storms'},	
	{ type: 'cloud', class: '', intensity: 1, name: '구름'}, 
	{ type: 'sun', class: '', intensity: 1, name: '맑음'},		
	{ type: 'haze', class: '', intensity: 1, name: '안개'},
	{ type: 'sunn', class: 'night', intensity: 1, icon: 'wi-night-clear', name: '저녁 맑음'},		
